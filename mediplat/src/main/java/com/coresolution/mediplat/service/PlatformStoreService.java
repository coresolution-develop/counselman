...
public class PlatformStoreService {
    ...
    public PlatformSessionUser authenticate(String instCode, String username, String rawPassword) {
        ...
        PlatformInstitution institution = findInstitution(authenticatedUser.instCode());
    ...
    public void saveInstitution(String instCode, String instName, String useYn) {
        ...
        if (!StringUtils.hasText(normalizedInstCode) || !StringUtils.hasText(instName)) {
        ...
        jdbcTemplate.update("""
                ...
                KEY (inst_code)
                VALUES (?, ?, ?)
                """, normalizedInstCode, instName.trim(), normalizedUseYn);
    }
    ...
    public void saveUser(String instCode, String username, String rawPassword, String displayName, String roleCode, String useYn) {
        ...
        if (findInstitution(normalizedInstCode) == null) {
        ...
        jdbcTemplate.update("""
                ...
                VALUES (?, ?, ?, ?, ?, ?)
                """, normalizedInstCode, normalizedUsername, hash, displayName.trim(), normalizedRole, normalizedUseYn);
    }
