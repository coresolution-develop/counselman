...
<head>
<meta charset="UTF-8">
<title>기관등록 : SOSYGE EASY-CRM</title>
...
<script src="/resources/js/csm/core/admin/newinstPopup.js"></script>
</head>
<body>
	<form action="/csm/core/inst/post" method="post"> 
		...
		<input type="text" class="user-area" id="id_col_02" name="id_col_02" placeholder="" required="required" />
		<label>
			기관코드
			<font color="red">*</font>
		</label>
		<input type="text" class="user-area" id="id_col_03" name="id_col_03" placeholder="" required="required" />
		<label>
			사업자등록번호
			<font color="red">*</font>
		</label>
		<input type="text" class="user-area" id="id_col_09" name="id_col_09" placeholder="" required="required" />
		<label>
			연락처(1)
			<font color="red">*</font>
		</label>
		<input type="text" class="user-area" id="id_col_06" name="id_col_06" placeholder="" required="required" />
		<label>
			연락처(2)
		</label>
		<input type="text" class="user-area" id="id_col_07" name="id_col_07" placeholder=""/>
		<label>
			주소
			<font color="red">*</font>
		</label>
		<input type="text" class="user-area" id="id_col_08" name="id_col_08" placeholder="" required="required" />
		<label>
			비고
		</label>
		<input type="text" class="user-area" id="id_col_05" name="id_col_05" placeholder=""/>
		<div class="btn-area">
