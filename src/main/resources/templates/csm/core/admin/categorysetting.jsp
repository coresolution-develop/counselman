...
<link rel="shortcut icon" href="/resources/icon/new/favicon-32.png">
<link rel="apple-touch-icon" sizes="180x180" href="/resources/icon/new/app-icon-180.png">
<link rel="icon" sizes="192x192" href="/resources/icon/new/app-icon-512.png">
...
<link rel="stylesheet" href="/resources/css/csm/core/admin/settingpopup.css">
						...
						<div class="inner-top">
							<div class="inner-section">
								<div class="inner-area">
									<span style="cursor:pointer;" onclick="location.href='/csm/core/setting'"  >템플릿 관리</span>
									|
									<span style="cursor:pointer; color: #06603A; font-weight: 500; margin: 5px; font-size: 12px;" onclick="location.href='/csm/core/categorysetting'" >상담일지양식 관리</span>
								</div>
							</div>
						</div>
					</div>
...
<!-- 									<div id="user-modi">수정</div> -->
									<c:choose>
										...
										<c:otherwise>
											<div class="btn newBtn pop-btn counsel-btn" id="user-new" style="height: 50px;">등록/수정</div>
										</c:otherwise>
									</c:choose>
			...
			<div class="content-bot" id="coretemplateModalContent">
			</div>
		</div>
	...
	<div class="popup-wrap" id="popup">
		<div class="popup">
			<div class="popup-head">
				<span class="head-title" id="head-title">카테고리 추가</span>
			</div>
			<form action="/csm/core/setting/template" method="post" style="height: calc(100% - 40px);">
						        ...
						        <div id="" class="category-container">
							        <div class="category-header">
										...
										<div class="settingDiv">
											<img class="search-text" id="setting-main" src="/resources/icon/ev/fix-icon.png">
										</div>
							        </div>
						            ...
						            <div class="category-container-wrap">
							            ...
							            <div id="main" class="cateButton">
			    							<button type="button" class="btn orderBtn" id="save-order-main" onclick="saveOrder('main')" style="display: none;" >순서저장</button>
								            <button type="button" class="btn delBtn setting-btn" id="del-maincategory" data-category-type="parent" >- 삭제</button>
								            <button type="button" class="btn newBtn" id="new-maincategory" data-category-type="parent" >+ 추가</button>
							            </div>
						            </div>
						        </div>
								<div id="" class="category-container">
									<div class="category-header">
										<h3>소분류</h3>
							            <div class="settingDiv">
											<img class="search-text" id="setting-sub" src="/resources/icon/ev/fix-icon.png">
										</div>
									</div>
						            <div class="category-container-wrap">
							            <div id="subCategoryDiv"></div>
							            <div id="sub" class="cateButton">
							            	<button type="button" class="btn orderBtn" id="save-order-sub" onclick="saveOrder('sub')" style="display: none;">순서저장</button>
								            <button type="button" class="btn delBtn setting-btn" id="del-subcategory" data-category-type="child" disabled>- 삭제</button>
								            <button type="button" class="btn newBtn" id="new-subcategory" data-category-type="child" disabled>+ 추가</button>
							            </div>
						            </div>
								</div>
								<div id="" class="category-container" style="margin: 0 7px 0 0;">
									<div class="category-header">
										<h3>옵션</h3>
							            <div class="settingDiv">
											<img class="search-text" id="setting-option" src="/resources/icon/ev/fix-icon.png">
										</div>
									</div>
						            <div class="category-container-wrap">
							            <div id="optionCategoryDiv"></div>
							            <div id="option" class="cateButton">
							            	<button type="button" class="btn orderBtn" id="save-order-option" onclick="saveOrder('option')" style="display: none;">순서저장</button>
								            <button type="button" class="btn delBtn setting-btn" id="del-optioncategory" data-category-type="option" disabled>- 삭제</button>
								            <button type="button" class="btn newBtn" id="new-optioncategory" data-category-type="option" disabled>+ 추가</button>
							            </div>
						            </div>
								</div>
							</div>
	...
	<div class="modal2 normal">
		<div class="modal_body2">
			<div>
				...
				<div class="menu_msg2">새로운 분류를 입력해주세요.</div>
				<input type="text" class="modal-input" id="modifyValue" name="modifyValue" placeholder="분류/옵션을 입력하세요.">
				<div class="modal_footer2">
					<div class="btn modal_btn2 listBtn" id="ModifyBtn">
						확인
					</div>
					<div class="btn pink_btn2 listBtn" onclick="closePopup2()">
						취소
					</div>
				</div>
			</div>
		...
		<div class="modal_body3">
			<div>
				...
				<div class="modal_footer3">
					<div class="btn modal_btn2 listBtn" id="ConfirmBtn">
						확인
					</div>
...
<script src="/resources/js/csm/core/admin/categorysetting.js"></script>
</body>
<script>
