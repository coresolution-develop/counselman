...
public class SsoService {
    ...
    public SsoService(
            @Value("${cancer-treatment.sso.shared-secret:}") String sharedSecret,
            @Value("${cancer-treatment.sso.allowed-clock-skew-seconds:60}") long allowedClockSkewSeconds,
            @Value("${cancer-treatment.sso.default-target:/cancer-treatment-schedule}") String defaultTarget) {
