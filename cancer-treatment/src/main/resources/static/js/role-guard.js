...
(function () {
    ...
    style.textContent = [
        ...
        // 신규 화면(스케줄 등록 · 각종 마스터) 쓰기 진입 버튼.
        'body[data-user-role="VIEWER"] #reg-open,',
        'body[data-user-role="VIEWER"] #dd-register,',
        'body[data-user-role="VIEWER"] #reg-submit,',
        'body[data-user-role="VIEWER"] #th-create-open,',
        'body[data-user-role="VIEWER"] #seat-create-open,',
        'body[data-user-role="VIEWER"] #opt-create-open,',
        'body[data-user-role="VIEWER"] [data-action="save"],',
